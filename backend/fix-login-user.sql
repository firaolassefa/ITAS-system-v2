...
-- Option 2: Change existing user to TAXPAYER (recommended - matches our changes)
UPDATE users SET user_type = 'TAXPAYER' WHERE username = 'taxpayer';

-- Option 3: Create a new TAXPAYER user if needed
-- INSERT INTO users (username, password, full_name, email, user_type, is_active, created_at)
-- VALUES ('taxagent', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhkO', 'Tax Agent User', 'taxagent@example.com', 'TAXPAYER', true, NOW())
